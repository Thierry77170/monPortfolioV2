            ...
            <section className='aboutMeSection'>
                ...
                <article className='aboutMeContainer'>
                    ...
                    <p className='aboutMeContainer__text'>
                        Après avoir exploré différents horizons professionnels, j'ai décidé d'effectuer une reconversion professionnel dans le développement web, un domaine qui m'anime depuis longtemps.
